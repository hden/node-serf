...
(function() {
  'use strict';
  var Decode, Stream, camelize, capitalize, debug, msgpack, net, _,
  ...
  Stream = require("" + __dirname + "/stream").Stream;
  ...
  exports.Serf = (function(_super) {
    ...
    Serf.prototype.send = function(Command, body, cb) {
      ...
      if (Command === 'stream' || Command === 'monitor') {
        ...
        this.on(Seq, ondata);
        stream.once('stop', (function(_this) {
          return function() {
            if (cb != null) {
